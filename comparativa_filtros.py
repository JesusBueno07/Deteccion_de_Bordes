    ...
    for y in range(1, alto-1):
        ...
        for j in range(-radio, radio+1):
            for i in range(-radio, radio+1):
                n += pixeles_grises[x+i, y+j][0] * roberts_gx_k[j+radio][i+radio]
...
for x in range(1, ancho-1):
    for y in range(1, alto-1):
        ...
        for j in range(-radio, radio+1):
            for i in range(-radio, radio+1):
                n += pixeles_grises[x+i, y+j][0] * roberts_gy_k[j+radio][i+radio]
...
for x in range(1, ancho-1):
    for y in range(1, alto-1):
        ...
        for j in range(-radio, radio+1):
            for i in range(-radio, radio+1):
                n += pixeles_grises[x+i, y+j][0] * prewitt_gx_k[j+radio][i+radio]
...
for x in range(1, ancho-1):
    for y in range(1, alto-1):
        ...
        for j in range(-radio, radio+1):
            for i in range(-radio, radio+1):
                n += pixeles_grises[x+i, y+j][0] * prewitt_gy_k[j+radio][i+radio]
...
for x in range(1, ancho-1):
    for y in range(1, alto-1):
        ...
        for j in range(-radio, radio+1):
            for i in range(-radio, radio+1):
                n += pixeles_grises[x+i, y+j][0] * sobel_gx_k[j+radio][i+radio]
...
for x in range(1, ancho-1):
    for y in range(1, alto-1):
        ...
        for j in range(-radio, radio+1):
            for i in range(-radio, radio+1):
                n += pixeles_grises[x+i, y+j][0] * sobel_gy_k[j+radio][i+radio]
...
gaussiano = Image.new("RGB", (ancho, alto), color="white")
pg = gaussiano.load()
for x in range(ancho):
    for y in range(alto):
        r = g = b = n = 0
...
# Cuadricula 2x2 de filtros a la derecha
...
plt.suptitle("Comparativa de detectores de bordes", fontsize=12)
plt.show()
